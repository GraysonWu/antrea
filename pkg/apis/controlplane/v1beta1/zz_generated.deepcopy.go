...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkPolicyQueryFilter) DeepCopyInto(out *NetworkPolicyQueryFilter) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkPolicyQueryFilter.
func (in *NetworkPolicyQueryFilter) DeepCopy() *NetworkPolicyQueryFilter {
	if in == nil {
		return nil
	}
	out := new(NetworkPolicyQueryFilter)
	in.DeepCopyInto(out)
	return out
}
