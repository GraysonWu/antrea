...
replace (
	...
	// init a fake client with 20k objects, which makes it hard to run the NetworkPolicy scale test.
	...
	// dependency version.
	k8s.io/client-go => github.com/tnqn/client-go v0.0.0-20200326152146-7ebc178578a3
)
